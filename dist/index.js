...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const res = yield slackClient.chat.postMessage(postArgs);
